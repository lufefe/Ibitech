...
public class Help extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout.setRenderer(new ExpandableLayout.Renderer<PhoneCategory,Phone>() {
            ...
            public void renderParent(View view, PhoneCategory phoneCategory, boolean isExpanded, int parentPosition) {
                ...
                view.findViewById(R.id.arrow).setBackgroundResource(isExpanded?R.drawable.arrow_up_float:R.drawable.arrow_down_float);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_dashboard) {
            startActivity(new Intent(Help.this,Dashboard.class));
        }
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                ...
                case 1:
                    ...
                    break;
                case 2:
                    fragment = new FragmentTermsAndConds();
                    break;
            }
            return fragment;
        }
